...
class BaseTransformer(pl.LightningModule):
    ...
    def total_steps(self) -> int:
        ...
        if self.hparams.accumulate_grad_batches==None:
    ...
    def add_model_specific_args(parser, root_dir):
        ...
        parser.add_argument("--loss_n", type=str, default='ce_mqs', help='loss name')
        parser.add_argument("--beta", type=float, default=1.0, help='loss name')
...
def generic_train(
    ...
    **extra_train_kwargs
    ...
    trainer = pl.Trainer.from_argparse_args(
        ...
        logger=logger,
        deterministic=True,
        reload_dataloaders_every_n_epochs=args.reload_data,
        ############
    ...
    if args.do_train:
        trainer.fit(model, val_dataloaders=None) #, val_dataloaders=model.val_dataloader())
